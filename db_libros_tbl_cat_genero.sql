...
CREATE TABLE `tbl_cat_genero` (
  ...
  `Genero_Nombre` varchar(60) DEFAULT NULL,
...
INSERT INTO `tbl_cat_genero` VALUES (1,'Terror',1),(2,'Ciencia Ficcion',1),(3,'Novela',1),(4,'Romance',1);
...
-- Dump completed on 2024-02-07  3:50:43
